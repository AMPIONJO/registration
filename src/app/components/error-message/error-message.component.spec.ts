...
describe('ErrorMessageComponent', () => {
  ...
  it('should show error message when field is touched and error present', ()=> {
  ...
  it('should hide error message on field touched and has error, but has a different error',()=>{
    component.field = new FormGroup({anyField: new FormControl()})
